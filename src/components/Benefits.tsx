...
export const Benefits: React.FC = () => {
  ...
  const secStyle = useSectionStyle('home-benefits', c);
  ...
  return (
    <section data-editor-section="home-benefits" style={secStyle} className="py-16 bg-neutral-50 border-b border-gray-100 animate-fadeInUp">
