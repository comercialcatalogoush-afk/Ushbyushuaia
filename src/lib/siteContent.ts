...
export const PAGE_SCHEMAS: PageSchema[] = buildSchemasWithSeo([
  {
    ...
    fields: [
      ...
      { key: 'benefitsCard2Text', label: 'Tarjeta 2 — descripción', type: 'textarea', group: 'Beneficios', default: '20% OFF desde 8 unidades por referencia elegida · precio de fábrica y envío gratis desde 12.' },
  ...
  },
  {
    ...
    fields: [
      ...
      // Aliados B2B — Fábrica Directa (Propuesta 2)
      { key: 'b2bEyebrow', label: 'B2B — Etiqueta superior', type: 'text', group: 'Aliados B2B', default: 'FÁBRICA DIRECTA ITAGÜÍ · DISTRIBUCIÓN NACIONAL' },
      { key: 'b2bTitle', label: 'B2B — Título principal', type: 'text', group: 'Aliados B2B', default: 'Programa de Aliados Comerciales B2B' },
      { key: 'b2bSubtitle', label: 'B2B — Subtítulo', type: 'textarea', group: 'Aliados B2B', default: 'Abastece tu boutique o tienda multimarca con denim 100% colombiano de alta rotación, sin las rigideces del modelo tradicional.' },
      { key: 'b2bDiff1Title', label: 'Diferencial 1 — Título', type: 'text', group: 'Aliados B2B', default: 'Curvas y Tallas Abiertas' },
      { key: 'b2bDiff1Desc', label: 'Diferencial 1 — Texto', type: 'textarea', group: 'Aliados B2B', default: 'Elige solo las tallas y siluetas que rotan en tu punto de venta. Cero inventario muerto obligado.' },
      { key: 'b2bDiff2Title', label: 'Diferencial 2 — Título', type: 'text', group: 'Aliados B2B', default: 'Surtido Libre desde 8 Unidades' },
      { key: 'b2bDiff2Desc', label: 'Diferencial 2 — Texto', type: 'textarea', group: 'Aliados B2B', default: 'Compra de 8 a 11 unidades con 20% OFF · desde 12 unidades obtienes precio de fábrica, surtido libre y flete gratis a todo el país.' },
      ...
      { key: 'b2bCalcCtaLink', label: 'Botón Calculadora — Enlace', type: 'url', group: 'Aliados B2B', default: '#calculadora' },

      // Contacto al pie de página (Beneficios)
      { key: 'ccContactEyebrow', label: 'Contacto — Etiqueta', type: 'text', group: 'Contacto al Pie', default: 'ATENCIÓN COMERCIAL DIRECTA' },
      { key: 'ccContactTitle', label: 'Contacto — Título', type: 'text', group: 'Contacto al Pie', default: '¿Tienes dudas sobre tu pedido mayorista?' },
      { key: 'ccContactIntro', label: 'Contacto — Descripción', type: 'textarea', group: 'Contacto al Pie', default: 'Nuestro equipo de asesores en Itagüí está listo para resolver tus preguntas sobre curvas, stock inmediato y despachos nacionales.' },
      { key: 'ccContactPhone', label: 'Contacto — Teléfono / WhatsApp', type: 'text', group: 'Contacto al Pie', default: '+57 301 139 3902' },
      { key: 'ccContactEmail', label: 'Contacto — Correo', type: 'text', group: 'Contacto al Pie', default: 'comercialmayoristas@ushuaiajeans.com.co' },
      { key: 'ccContactAddress', label: 'Contacto — Dirección', type: 'text', group: 'Contacto al Pie', default: 'Carrera 55 B # 72 a 02, Itagüí, Antioquia, Colombia' },
      { key: 'ccContactHours', label: 'Contacto — Horario', type: 'text', group: 'Contacto al Pie', default: 'Lun – Jue: 7:00 AM – 4:00 PM | Vie: 7:00 AM – 3:30 PM' },
      { key: 'ccContactWaButton', label: 'Contacto — Botón WhatsApp', type: 'text', group: 'Contacto al Pie', default: 'Hablar con Asesor por WhatsApp' },
    ],
  },
  {
    id: 'calculadora',
    label: 'Calculadora Mayorista',
    description: 'Textos y condiciones de la calculadora privada de rentabilidad para clientes registrados.',
    fields: [
      { key: 'calcEyebrow', label: 'Etiqueta superior', type: 'text', group: 'Encabezado', default: 'SIMULADOR DE RENTABILIDAD B2B · EXCLUSIVO MAYORISTAS' },
      { key: 'calcTitle', label: 'Título principal', type: 'text', group: 'Encabezado', default: 'Calculadora de Inversión y Ganancias' },
      { key: 'calcSubtitle', label: 'Subtítulo', type: 'textarea', group: 'Encabezado', default: 'Arma tu surtido con cualquiera de nuestras 90 referencias oficiales. Proyecta tu inversión, margen de vitrina y retorno neto en tiempo real.' },
      { key: 'calcMinNotice', label: 'Nota compra mínima', type: 'textarea', group: 'Condiciones', default: 'Escala mayorista activa desde 8 unidades (20% OFF). A partir de 12 unidades surtidas obtienes precio oficial de fábrica + Envío Gratis Nacional.' },
      { key: 'calcLockedTitle', label: 'Título acceso restringido', type: 'text', group: 'Privacidad', default: 'Acceso Exclusivo para Mayoristas Registrados' },
      { key: 'calcLockedDesc', label: 'Descripción acceso restringido', type: 'textarea', group: 'Privacidad', default: 'Para proteger los márgenes y precios de nuestros clientes distribuidores y boutiques, este simulador financiero requiere una cuenta activa en el catálogo digital.' },
    ],
  },
  {
    id: 'contacto',
    ...
    fields: [
      ...
      { key: 'ctLocation', label: 'Ubicación', type: 'text', group: 'Datos oficiales', default: 'Carrera 55 B # 72 a 02, Itagüí, Antioquia, Colombia' },
      { key: 'ctSchedule1', label: 'Horario semana', type: 'text', group: 'Datos oficiales', default: 'Lun – Jue: 7:00 AM – 4:00 PM | Vie: 7:00 AM – 3:30 PM' },
      { key: 'ctSchedule2', label: 'Nota de horario', type: 'text', group: 'Datos oficiales', default: 'Sábados, domingos y festivos cerrado.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'plChannelsAddress', label: 'Punto de despacho', type: 'text', group: 'Canales de atención', default: 'Carrera 55 B # 72 a 02, Itagüí, Antioquia, Colombia' },
    ],
  },
  {
    id: 'footer',
    ...
    fields: [
      { key: 'footerDescription', label: 'Descripción de la marca', type: 'textarea', group: 'Marca', default: 'Marca líder en confección y distribución mayorista de prendas en tela de alta confección. Calidad, tendencia y volumen para tiendas y distribuidores en Colombia.' },
      ...
      { key: 'footerNoticeText', label: 'Aviso mayorista — texto', type: 'textarea', group: 'Mayoristas', default: 'Desde 8 unidades obtienes 20% OFF. Desde 12 unidades surtidas aplica precio mayorista de fábrica con envío gratis a todo el país.' },
      { key: 'footerCtaText', label: 'Botón — texto', type: 'text', group: 'Mayoristas', default: 'Pedir Asesoría' },

      { key: 'footerHoursTitle', label: 'Horario — título', type: 'text', group: 'Contacto', default: 'Horario Canal Mayorista' },
      { key: 'footerHoursWeek', label: 'Horario — semana', type: 'text', group: 'Contacto', default: '7:00 AM – 4:00 PM' },
