...
export const PAGE_SCHEMAS: PageSchema[] = buildSchemasWithSeo([
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'ccContactAddress', label: 'Contacto — Dirección', type: 'text', group: 'Contacto al Pie', default: 'Cll. 85 Sur #50-72, Itagüí, Antioquia — Colombia' },
      { key: 'ccContactHours', label: 'Contacto — Horario', type: 'text', group: 'Contacto al Pie', default: 'Lunes a Viernes: 8:00 AM – 5:30 PM' },
