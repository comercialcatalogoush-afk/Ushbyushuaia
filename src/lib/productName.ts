...
export function abbreviateProductName(input: AbbrevInput): AbbreviatedName {
  ...
  const FIT_KEYWORDS: Array<{ test: RegExp; label: string }> = [
    ...
    { test: /\bboot\b/i, label: 'Boot' },
    { test: /\bcargo\b/i, label: 'Cargo' },
    { test: /\bstraight\b/i, label: 'Straight' },
    { test: /\brecto\b/i, label: 'Recto' },
    { test: /\bwide leg\b/i, label: 'Wide Leg' },
    { test: /\bwide\b/i, label: 'Wide' },
    { test: /\bbarrel\b/i, label: 'Barrel' },
    { test: /\btapered\b/i, label: 'Tapered' },
    { test: /\bmom\b/i, label: 'Mom' },
    { test: /\bdad\b/i, label: 'Dad' },
    { test: /\bboyfriend\b/i, label: 'Boyfriend' },
    { test: /\bflare\b/i, label: 'Flare' },
    { test: /\bbaggy\b/i, label: 'Baggy' },
