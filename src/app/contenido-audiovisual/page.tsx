...
export default function AudiovisualPage() {
  ...
  return <div className="bg-[#f8f8f8] px-3 py-8 sm:px-5 sm:py-10"><div className="mx-auto max-w-7xl"><div className="mb-5 flex items-center justify-between gap-3"><Link href="/profile" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-neutral-500 hover:text-[#d88193]"><ArrowLeft size={15} /> Volver a mi cuenta</Link><span className="hidden text-[10px] font-bold uppercase tracking-wider text-neutral-400 sm:block">USH BY USHUAIA · Biblioteca para compartir</span></div><section className="mb-5 border border-[#1b2333] bg-[#1b2333] px-5 py-7 text-white shadow-sm sm:px-8 sm:py-9"><p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#f3b3c0]">Tu espacio de contenido</p><h1 className="mt-2 text-2xl font-black uppercase tracking-tight sm:text-4xl">Contenido audiovisual</h1><p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/70">Elige las referencias que quieres publicar, descarga sus fotos y videos y lleva la colección USH BY USHUAIA directamente a tus redes sociales.</p><div className="mt-5 flex flex-wrap gap-2 text-[10px] font-bold uppercase tracking-wide text-white/80"><span className="border border-white/15 bg-white/5 px-3 py-2">Fotos listas para compartir</span><span className="border border-white/15 bg-white/5 px-3 py-2">Videos de referencia</span><span className="border border-white/15 bg-white/5 px-3 py-2">Sin guardar archivos en la plataforma</span></div></section><CustomerAudiovisualContent products={products} fullPage /></div></div>;
}
