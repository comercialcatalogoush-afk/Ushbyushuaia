...
-- Insert Products extracted from Wix Catalog
INSERT INTO public.products (id, name, reference, slug, price, compare_price, ribbon, description, in_stock, options, images, category_id)
VALUES 
(
    ...
    0.00,
    'Nuevo',
    'Short largo de alta calidad confeccionado con mezclilla de la más alta resistencia. Ideal para catálogo mayorista.',
    TRUE,
    '[{"id":"1fb7b7af-e9d7-4e1f-a2e2-8ba56001405c","key":"Talla","values":["6","8","10","12","14","16"]}]'::jsonb,
    ARRAY[
...
(
    ...
    0.00,
    '',
    'Falda Dama Rígida Color Crudo. Diseño elegante y exclusivo para boutiques y comerciantes.',
    TRUE,
...
(
    ...
    0.00,
    'Más vendido',
    'Jean Dama Wide Leg Tiro Alto Rígido Color Azul Oscuro. Referencia top en ventas.',
    TRUE,
    '[{"id":"ea9db20d-2e1a-4fe7-825f-b45a82a9d1e7","key":"Color","values":["Azul Oscuro"]},{"id":"1fb7b7af-e9d7-4e1f-a2e2-8ba56001405c","key":"Talla","values":["6","8","10","12","14","16"]}]'::jsonb,
    ARRAY[
